var queryinsertOrden="insert into orden_cobro (codigocatastral,nombres,estado,valor,ano,direccion) values ('"
...
module.exports = { 
  ...
  todosOrdenesId: function (myPool, callback){
      ejecutarQuery (myPool, "select codigocatastral from orden_cobro", callback)
  }, 
